...
/**
 * Convert {name:'xx',value:xx} serie-format data to geo-based scatter data
 *
 * @param  {Array} data serie-format data
 * @return {Array}      geo-based data
 *
 * Example result: [{name: 'xxx', value: [121.15, 31.89, 123]}]
 */
